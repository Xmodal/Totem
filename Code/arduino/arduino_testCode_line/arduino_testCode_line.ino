...
void loop() {
  ...
  */
  ...
  val = (val + 1) % 360; 
  for (int i = 0; i < 9; i++)//loop trough the 9 led strips outputs
  {
    for (int j = 0; j < 360; j++)//loop through the first 36 leds of the strip (change 36 to 386 for the 11 boxes)
    {     
